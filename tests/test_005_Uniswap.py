...
def test_u3_standalone():
    ...
    assert (
        u.price_convention
        == "0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48/0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2 [0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2 per 0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48]"
    )
...
def test_univ3_issue():
    ...
    u3data = dict(
        ...
        anchor="NaN",
        tkn0="0x8E870D67F660D95d5be530380D0eC0bd388289E1",
    ...
    u3 = U3.from_dict(
        u3data,
        tkn0decv=u3data["tkn0_decimals"],
        tkn1decv=u3data["tkn1_decimals"],
        fee_const=U3.FEE100,
    )
...
def test_with_cpc():
    ...
    print(
        f"TVL = {c.tvl(tkn=c.tknx):,.3f} {c.tknx} = {c.tvl(tkn=c.tkny):,.3f} {c.tkny}"
    )
    ...
    print(
        f"TVL = {u.tvl(astkn0=True):,.3f} {c.tknx} = {u.tvl(astkn0=False):,.3f} {c.tkny}"
    )
