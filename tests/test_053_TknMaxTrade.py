...
def test_test_use_0_for_sourceamount():
    ...
    assert (
        max_trade_route_struct[0].sourceAmount == 0
    ), f"[NBTest_053] sourceAmount expected 0, actual: {max_trade_route_struct[0].sourceAmount}"
    assert (
        max_trade_route_struct[1].sourceAmount == 0
    ), f"[NBTest_053] sourceAmount expected 0, actual: {max_trade_route_struct[1].sourceAmount}"
    assert (
        max_trade_route_struct2[0]["sourceAmount"] == 62211456000000000000
    ), f"[NBTest_053] sourceAmount expected 0, actual: {max_trade_route_struct2[0]['sourceAmount']}"
    assert (
        max_trade_route_struct2[1]["sourceAmount"] == 0
    ), f"[NBTest_053] sourceAmount expected 0, actual: {max_trade_route_struct2[1]['sourceAmount']}"
    assert (
        max_trade_route_struct2[2]["sourceAmount"] == 0
    ), f"[NBTest_053] sourceAmount expected 0, actual: {max_trade_route_struct2[2]['sourceAmount']}"
