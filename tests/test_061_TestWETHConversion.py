# ------------------------------------------------------------
# Auto generated test file `test_061_TestWETHConversion.py`
# ------------------------------------------------------------
# source file   = NBTest_061_TestWETHConversion.py
# test id       = 061
# test comment  = TestWETHConversion
# ------------------------------------------------------------
...
from fastlane_bot.helpers.routehandler import (
    maximize_last_trade_per_tkn,
)  # ,BalancerInputTooLargeError
...
# ------------------------------------------------------------
# Test      061
# File      test_061_TestWETHConversion.py
# Segment   Test_Wrap_Unwrap_Gas_Token_In_Route_Struct
# ------------------------------------------------------------
def test_test_wrap_unwrap_gas_token_in_route_struct():
    # ------------------------------------------------------------
    ...
    for arb in r:
        ...
        calculated_trade_instructions = tx_route_handler.calculate_trade_outputs(
            trade_instructions=agg_trade_instructions
        )
