...
SOLIDLY_FORKS = [AERODROME_V2_NAME, VELOCIMETER_V2_NAME, SCALE_V2_NAME, VELODROME_V2_NAME, CLEOPATRA_V2_NAME, STRATUM_V2_NAME, XFAI_NAME]
...
EXCHANGE_IDS = {
    ...
    STRATUM_V2_NAME: 12,
    XFAI_NAME: 13 #TODO verify with contracts
}
