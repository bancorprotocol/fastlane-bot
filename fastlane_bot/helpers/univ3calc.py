...
class Univ3Calculator():
    ...
    TICKSZ = {FEE50: 1, FEE80: 1, FEE100: 1, FEE250: 5, FEE450: 10, FEE500: 10, FEE2500: 50, FEE3000: 60, FEE10000: 200}
    ...
    ADDRDEC = {
        # only for testing
        "0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48": ("0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48", 6),
        "0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2": ("0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2", 18),
    }
    ...
    def __post_init__(self, tkn0decv=None, tkn1decv=None, addrdec=None):
        ...
        assert self.fee_const in {self.FEE50, self.FEE80,self.FEE100, self.FEE250, self.FEE450, self.FEE500, self.FEE2500, self.FEE3000, self.FEE10000}, f"fee not one of the FEEXXX constants {self.fee_const}"
