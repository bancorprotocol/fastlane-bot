...
class ConfigNetwork(ConfigBase):
    ...
    #######################################################################################
    UNIV3_FEE_LIST = [50, 80, 100, 250, 450, 500, 2500, 3000, 10000]
...
class _ConfigNetworkArbitrumOne(ConfigNetwork):
    ...
    CARBON_CONTROLLER_ADDRESS = "0x6bD85183abBF0990955cFce1cf0674D1d6c30E05"
    CARBON_CONTROLLER_VOUCHER = "0xd14C2CE7217eA6B9B736f341e4535E37741E2ED7"
