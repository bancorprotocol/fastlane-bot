...
class ConfigNetwork(ConfigBase):
    ...
    EXCHANGE_IDS = {
        ...
        BALANCER_NAME: 7,
        CARBON_POL_NAME: 8,
        PANCAKESWAP_V2_NAME: 9,
        PANCAKESWAP_V3_NAME: 10
    }
    UNIV2_FORKS = [UNISWAP_V2_NAME, SUSHISWAP_V2_NAME, PANCAKESWAP_V2_NAME]
    UNIV3_FORKS = [UNISWAP_V2_NAME, SUSHISWAP_V3_NAME, PANCAKESWAP_V3_NAME]
