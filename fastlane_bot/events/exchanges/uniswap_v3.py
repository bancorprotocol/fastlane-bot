...
from fastlane_bot.data.abi import UNISWAP_V3_POOL_ABI, PANCAKESWAP_V2_POOL_ABI, UNISWAP_V3_FACTORY_ABI, \
...
class UniswapV3(Exchange):
    ...
    def get_abi(self):
        return UNISWAP_V3_POOL_ABI if self.exchange_name not in "pancakeswap_v2" else PANCAKESWAP_V2_POOL_ABI

    @property
    def get_factory_abi(self):
        return UNISWAP_V3_FACTORY_ABI if "pancake" not in self.exchange_name else PANCAKESWAP_V3_FACTORY_ABI
