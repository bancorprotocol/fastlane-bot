...
def manager(pool_data):
    ...
    w3 = cfg.w3
    manager = Manager(cfg=cfg, pool_data=pool_data, alchemy_max_block_fetch=20, web3=w3, SUPPORTED_EXCHANGES=['bancor_v3','carbon_v1'])
    return manager
...
def test_update_pools_directly_from_contracts_bancor_v3(self, update_mock, manager, pool_data):
...
def test_get_strats_by_pair(self, manager):
    ...
    brownie.multicall.assert_called_once_with(address='0x5BA1e12693Dc8F9c48aAD8770482f4739bEeD696')
