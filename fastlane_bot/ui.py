...
class FastLaneArbBotUI(
    ...
    def execute_carbon(self, routes: [Route]):
        ...
        flash_token = route.p1.tkn0.address
        ...
        try:
            if route_struct:
                ...
                logger.info(
                    f"\nRoute to execute: routes: {route_struct}, sourceAmount: {src_amt}, expected_profit before split: {profit}, after = {profit * ec.DEFAULT_REWARD_PERCENT} \n\n"
                )
