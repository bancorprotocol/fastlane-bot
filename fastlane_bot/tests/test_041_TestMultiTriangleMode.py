# ------------------------------------------------------------
# Auto generated test file `test_041_TestMultiTriangleMode.py`
# ------------------------------------------------------------
# source file   = NBTest_041_TestMultiTriangleMode.py
# test id       = 041
# test comment  = TestMultiTriangleMode
# ------------------------------------------------------------
...
# ------------------------------------------------------------
# Test      041
# File      test_041_TestMultiTriangleMode.py
