...
from fastlane_bot.helpers import TradeInstruction, TxReceiptHandler, TxRouteHandler, TxSubmitHandler, TxHelpers, \
    TxHelper, add_wrap_or_unwrap_trades_to_route, split_carbon_trades
...
def test_wrap_unwrap_original():
    for arb in r:
        ...
        route_struct_before = route_struct
        route_struct = add_wrap_or_unwrap_trades_to_route(cfg, flashloan_struct, route_struct, calculated_trade_instructions)
