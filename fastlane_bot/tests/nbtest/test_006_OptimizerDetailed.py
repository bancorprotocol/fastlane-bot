# ------------------------------------------------------------
# Auto generated test file `test_006_OptimizerDetailed.py`
# ------------------------------------------------------------
# source file   = NBTest_006_OptimizerDetailed.py
# test id       = 006
# test comment  = OptimizerDetailed
# ------------------------------------------------------------
...
# ------------------------------------------------------------
# Test      006
# File      test_006_OptimizerDetailed.py
