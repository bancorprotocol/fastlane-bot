...
# Segment   moving this into a test so it does not kill the series
# ------------------------------------------------------------
def test_moving_this_into_a_test_so_it_does_not_kill_the_series():
# ------------------------------------------------------------
...
# Test      036
# File      test_036_Manager.py
# Segment   test_update_pools_directly_from_contracts_bancor_v3
# ------------------------------------------------------------
def test_test_update_pools_directly_from_contracts_bancor_v3():
# ------------------------------------------------------------
...
# Test      036
# File      test_036_Manager.py
# Segment   test_get_strats_by_pair
# ------------------------------------------------------------
def test_test_get_strats_by_pair():
# ------------------------------------------------------------
