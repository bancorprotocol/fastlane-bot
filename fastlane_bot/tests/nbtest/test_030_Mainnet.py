# ------------------------------------------------------------
# Auto generated test file `test_030_Mainnet.py`
# ------------------------------------------------------------
# source file   = NBTest_030_Mainnet.py
# test id       = 030
# test comment  = Mainnet
# ------------------------------------------------------------
...
# ------------------------------------------------------------
# Test      030
# File      test_030_Mainnet.py
# Segment   Overall market [NOTEST]
# ------------------------------------------------------------
def notest_overall_market():
# ------------------------------------------------------------
