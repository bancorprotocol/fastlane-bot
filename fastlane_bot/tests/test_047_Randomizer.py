...
# ------------------------------------------------------------
    ...
    for num_of_items in range(1, 6):
        arb_opp = rand_item(list_of_items=arb_opps, num_of_items=num_of_items)
        assert arb_opp in arb_opps[:num_of_items], f"[NB047 Randomizer], expected random arb opportunity to be one of the first {num_of_items} items on the list"
