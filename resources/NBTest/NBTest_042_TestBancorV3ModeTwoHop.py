...
assert iseq(optimal_arb, 4238.838700362472), f"[test_bancor_v3_two_hop] Optimal arb calculation type is {optimal_arb}, expected 4238.838700362472"
...
p0t0 = first_check_pools[0].x_act if tkn1 == flt else first_check_pools[0].y_act
p0t1 = first_check_pools[0].y_act if tkn1 == flt else first_check_pools[0].x_act
...
assert iseq(optimal_arb, optimal_arb_low_level_check), f"[test_bancor_v3_two_hop] Arb calculation result mismatch, pools likely ordered incorrectly"
