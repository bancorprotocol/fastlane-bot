...
# python main.py --arb_mode=single_triangle_bancor3 --static_pool_data_filename=static_pool_data --static_pool_data_sample_sz=200 --alchemy_max_block_fetch=200 --dbfs_path="" --loglevel=DEBUG
