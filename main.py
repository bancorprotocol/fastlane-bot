...
def run(mgr, args, tenderly_uri=None) -> None:
    ...
    while True:
        ...
        print(f"mgr.strategies_created: {mgr.strategies_created}")

        if kill_switch:
            print(f"kill_switch_event: {kill_switch_event}")
            # raise Exception("[main.py] StrategyCreated event detected. Stop.")
